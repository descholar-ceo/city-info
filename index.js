...
const isSearchStringValid = searchQuery => {
    ...
    if (searchQuery.match(detectNumber)) {
        ...
        return false;
    } else if (searchQuery.match(startWithWhiteSpaceDetected)) {
        searchReasult.classList.remove('hidden');
...
/** function to handle closing of a single city or sate result if the red button clicked by the user */
